...
public class Cat150Item210Test extends MandatoryFixedLengthAsterixTests<Cat150Item220> {
    @Override
    ...
    public void the_decode_method_should_correctly_decode_data() {
        ...
        //assert
        assertEquals("Item not decoded correctly", 33282, cat150Item220.getCorrelatedTrackNb());
    }
}
