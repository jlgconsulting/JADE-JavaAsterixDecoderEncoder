...
import jlg.jade.asterix.cat062.item340.Cat062Item340Subfield5;
...
public class Cat062Item340Subfield5Test extends MandatoryFixedLengthAsterixTests<Cat062Item340Subfield5> {
    @Override
    ...
    @Override
    protected Cat062Item340Subfield5 setFixedLengthAsterixDataInstance() {
        return new Cat062Item340Subfield5();
    }
    ...
    public void the_decode_method_should_correctly_decode_mode_a_validation(int firstOctet, boolean expected) {
        ...
        int offset = 0;
        Cat062Item340Subfield5 subfield5 = new Cat062Item340Subfield5();
