...
import jlg.jade.asterix.cat062.item380.Cat062Item380Subfield14;
...
public class Cat062Item380Subfield14Test extends MandatoryFixedLengthAsterixTests<Cat062Item380Subfield14> {
    @Override
    ...
    @Override
    protected Cat062Item380Subfield14 setFixedLengthAsterixDataInstance() {
        return new Cat062Item380Subfield14();
    }
    ...
    public void the_decode_method_should_correctly_decode_data(int firstOctet, int secondOctet, int expected){
        ...
        int offset = 0;
        Cat062Item380Subfield14 subfield = new Cat062Item380Subfield14();
