...
import jlg.jade.asterix.cat062.item390.Cat062Item390Subfield4;
...
public class Cat062Item390Subfield4Test extends MandatoryFixedLengthAsterixTests<Cat062Item390Subfield4> {
    @Override
    ...
    @Override
    protected Cat062Item390Subfield4 setFixedLengthAsterixDataInstance() {
        return new Cat062Item390Subfield4();
    }
    ...
    public void the_decode_method_should_correctly_decode_traffic_type(int firstOctet, int expected) {
        ...
        int offset = 0;
        Cat062Item390Subfield4 subfield4 = new Cat062Item390Subfield4();
