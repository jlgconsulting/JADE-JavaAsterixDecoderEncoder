...
import jlg.jade.asterix.cat062.item380.Cat062Item380Subfield13;
...
public class Cat062Item380Subfield13Test extends MandatoryFixedLengthAsterixTests<Cat062Item380Subfield13> {
    @Override
    ...
    @Override
    protected Cat062Item380Subfield13 setFixedLengthAsterixDataInstance() {
        return new Cat062Item380Subfield13();
    }
    ...
    public void the_decode_method_should_correctly_decode_data(int firstOctet, int secondOctet, int expected) {
        ...
        int offset = 0;
        Cat062Item380Subfield13 subfield = new Cat062Item380Subfield13();
