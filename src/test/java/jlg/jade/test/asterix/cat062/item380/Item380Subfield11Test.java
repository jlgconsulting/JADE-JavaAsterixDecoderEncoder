...
public class Item380Subfield11Test extends MandatoryFixedLengthAsterixTests<Item380Subfield11> {
    @Override
    ...
    @Override
    protected Item380Subfield11 setFixedLengthAsterixDataInstance() {
        return new Item380Subfield11();
    }
