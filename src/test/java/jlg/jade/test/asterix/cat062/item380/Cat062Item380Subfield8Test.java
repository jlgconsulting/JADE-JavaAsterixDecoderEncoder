...
import jlg.jade.asterix.cat062.item380.Cat062Item380Subfield8;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class Cat062Item380Subfield8Test {
    @Test
    public void the_decode_method_should_always_set_valid_flag_to_true(){
        //arrange
        byte[] input = {2}; //0000 0010
        int offset = 0;
        Cat062Item380Subfield8 subfield = new Cat062Item380Subfield8();
