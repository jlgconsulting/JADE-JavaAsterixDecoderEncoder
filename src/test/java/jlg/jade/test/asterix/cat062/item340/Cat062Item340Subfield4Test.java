...
import jlg.jade.asterix.cat062.item340.Cat062Item340Subfield4;
...
public class Cat062Item340Subfield4Test extends MandatoryFixedLengthAsterixTests<Cat062Item340Subfield4> {
    @Override
    ...
    @Override
    protected Cat062Item340Subfield4 setFixedLengthAsterixDataInstance() {
        return new Cat062Item340Subfield4();
    }
    ...
    public void the_decode_method_should_correctly_decode_the_validation_info(int firstOctet, boolean expected) {
        ...
        int offset = 0;
        Cat062Item340Subfield4 subfield4 = new Cat062Item340Subfield4();
