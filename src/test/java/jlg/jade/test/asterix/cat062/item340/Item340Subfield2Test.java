...
import jlg.jade.asterix.cat062.item340.Item340Subfield2;
import jlg.jade.test.utils.MandatoryFixedLengthAsterixTests;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class Item340Subfield2Test extends MandatoryFixedLengthAsterixTests<Item340Subfield2> {
    @Override
    ...
    @Override
    protected Item340Subfield2 setFixedLengthAsterixDataInstance() {
        return new Item340Subfield2();
    }
    ...
    public void the_decode_method_should_correctly_decode_data(){
        ...
        int offset = 0;
        Item340Subfield2 subfield2 = new Item340Subfield2();
