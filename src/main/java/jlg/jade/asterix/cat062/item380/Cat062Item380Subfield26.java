 ...
 */
public class Cat062Item380Subfield26 extends FixedLengthAsterixData {
    ...
    public byte[] encode() {
        byte[] itemAsByteArray = ByteBuffer.allocate(this.sizeInBytes)
                .putShort((short) this.indicatedAirSpeed)
                .array();
    ...
    protected String setDisplayName() {
        return "Cat062Item380Subfield26 - Indicated Air Speed";
    }
    ...
    /**
     * Set the aircraft indicated air speed. Unit of measure: knots
     * @param indicatedAirSpeed
     */
    public void setIndicatedAirSpeed(int indicatedAirSpeed) {
